...
.dlls,er4f .dlls: mmw_mss.per4f

-include package/cfg/mmw_mss_per4f.mak
-include package/cfg/mmw_mss_per4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/mmw_mss_per4f.dep
endif
mmw_mss.per4f: package/cfg/mmw_mss_per4f.xdl
	@


ifeq (,$(wildcard .libraries,er4f))
mmw_mss.per4f package/cfg/mmw_mss_per4f.c: .libraries,er4f
endif

package/cfg/mmw_mss_per4f.c package/cfg/mmw_mss_per4f.h package/cfg/mmw_mss_per4f.xdl: override _PROG_NAME := mmw_mss.xer4f
package/cfg/mmw_mss_per4f.c: package/cfg/mmw_mss_per4f.cfg
package/cfg/mmw_mss_per4f.xdc.inc: package/cfg/mmw_mss_per4f.xdl
package/cfg/mmw_mss_per4f.xdl package/cfg/mmw_mss_per4f.c: .interfaces

clean:: clean,er4f
	-$(RM) package/cfg/mmw_mss_per4f.cfg
	-$(RM) package/cfg/mmw_mss_per4f.dep
	-$(RM) package/cfg/mmw_mss_per4f.c
	-$(RM) package/cfg/mmw_mss_per4f.xdc.inc

clean,er4f::
	-$(RM) mmw_mss.per4f
.executables,er4f .executables: mmw_mss.xer4f

mmw_mss.xer4f: |mmw_mss.per4f

-include package/cfg/mmw_mss.xer4f.mak
mmw_mss.xer4f: package/cfg/mmw_mss_per4f.oer4f 
	$(RM) $@
	@$(MSG) lnker4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.R4F.rootDir)/bin/armlnk -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7R4 --strict_compatibility=on  -o $@ package/cfg/mmw_mss_per4f.oer4f   package/cfg/mmw_mss_per4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.R4F.rootDir)/lib/libc.a
	
mmw_mss.xer4f: export C_DIR=
mmw_mss.xer4f: PATH:=$(ti.targets.arm.elf.R4F.rootDir)/bin/;$(PATH)
mmw_mss.xer4f: Path:=$(ti.targets.arm.elf.R4F.rootDir)/bin/;$(PATH)

mmw_mss.test test,er4f test: mmw_mss.xer4f.test

mmw_mss.xer4f.test:: mmw_mss.xer4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 mmw_mss.xer4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.mmw_mss.xer4f, ) 
endif

clean,er4f::
	-$(RM) $(wildcard .tmp,mmw_mss.xer4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
mmw_mss_per4f.oer4f,copy : package/cfg/mmw_mss_per4f.oer4f
mmw_mss_per4f.ser4f,copy : package/cfg/mmw_mss_per4f.ser4f
